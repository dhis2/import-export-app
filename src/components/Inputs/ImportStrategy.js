...
export const OPTION_CREATE_AND_UPDATES = {
    value: 'CREATE_AND_UPDATES',
...
export const IMPORT_STRATEGY_DEFAULT_VALUE = OPTION_CREATE_AND_UPDATES.value
