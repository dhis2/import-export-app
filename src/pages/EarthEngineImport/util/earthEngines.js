...
export const earthEngines = {
    ...
    [POPULATION_TOTAL_EE_ID_V2]: {
        ...
        datasetId: POPULATION_TOTAL_EE_ID_V2,
    ...
    [POPULATION_AGE_GROUPS_EE_ID_V2]: {
        earthEngineId: POPULATION_AGE_GROUPS_EE_ID_V2,
        datasetId: POPULATION_AGE_GROUPS_EE_ID_V2,
        name: i18n.t('Population age groups v2'),
        source: SOURCE_NAME,
        sourceUrl: SOURCE_URL,
        img: 'images/population.png',
        periodType: 'Yearly',
