Feature: Offer attributes as options in data element id scheme input
    ...
    Scenario: A unique attribute is associated with data elements when importing data
    ...
    Scenario: A unique attribute is associated with data elements when exporting data
        Given a unique attribute is associated with data elements
